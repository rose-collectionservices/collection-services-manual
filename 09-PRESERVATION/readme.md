...
* There is a [centralized spreadsheet](https://emory-my.sharepoint.com/:x:/g/personal/ebrow38_emory_edu/EUIliMUVCK1PtQC5oouiHekB_Bt_7SZIrxIJYjSpJVMG4w?e=moARGZ) to track pest traps in the Woodruff Library building.
  	...
  	* When bugs are found in a trap, note it on the spreadsheet on the Rose tab, including the date, location, and kind of bug.
