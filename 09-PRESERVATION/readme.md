...
When working with moldy materials, segregate the damaged items from the rest of the collection. Those items will go to the conservation lab for cleaning. When they return, complete processing but keep the moldy material physically segregated. Physically add them to a new box(es) at the end of the collection and describe them intellectually in the finding aid. Label the outside of the box(es) with "Mold Alert" labels according to instructions in  [06 Local Practice](/06-LOCAL%20PRACTICE#662-boxing-collections).
