...
* [**When technical problems occur during processing:**]
...
*	[**At the collection level when some or all material cannot be made available:**] Due to technical complications, the Rose Library is currently unable to provide access to unprocessed born-digital materials.
...
* The reproduction of digital files from this collection is not permitted. Researchers are not permitted to copy, download, or photograph any of the digital files from the computer workstation. [Currently used if the collection includes digital material with a photography/photocopy restriction. A version of this note might appear on older finding aids that do allow personal photography or copy requests; check for any restriction information to determine whether they should be permitted.]
