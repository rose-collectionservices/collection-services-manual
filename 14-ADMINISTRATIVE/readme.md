...
At the end of each fiscal year, the Head of Processing, in consultation with the Rose Library Public Services Unit and the Curatorial Unit, determines priorities for in-depth processing projects for the upcoming year. They base their decisions on use in the reading room, input from the Public Services and Curatorial Units, accessioning lists, and conservation needs. The Head of Processing assigns projects to each processing archivist.

The Archivist creates a work plan, sets goals, and directs student work. When working with students, the archivist must ensure that the collections are being processed according to professional standards. Processing includes physical arrangement and foldering as well as description such as scope and content and biographical/historical notes. The Archivist is responsible for the arrangement plan, but processing students should feel confident to discuss other options and ideas with the Archivist. As students work through their assignments, they may discover information or records that will alter the original arrangement plan. It is important that students share such information so appropriate decisions can be made. Since students may be responsible for discreet sections of the collection, communication is key to ensuring that relationships between sections are maintained and well described.

The Archivist generally is responsible for compiling the component-level descriptions into a finding aid and creating the collection level description. However, as processing students gain more experience, the Archivist may delegate some or all of this work. The  Archivist reviews the finding aid, paying attention to the portions for which the processing students are responsible. The Archivist should share any changes or corrections with the students, particularly if these affect the physical arrangement of folders within the collection. When the finding aid is complete, the Archivist will send it to other archivists for review [see 6.3.2 Reviewing the Finding Aid](https://github.com/rose-collectionservices/collection-services-manual/tree/master/06-DESCRIPTION#632-reviewing-the-finding-aid).

### 14.1.2 Work Plans
Work plans are the blueprints for processing a collection. The work plan outlines the arrangement of a collection, identifies a collection's preservation needs, and recommends appraisal and weeding actions. The work plan also includes estimates of the time needed to process the collection and processing assignments for each component. The work plan will also contain information found in the collection file, including restrictions placed on the materials and important information about the creator or the custodial history of the collection that may affect processing. As processing proceeds, team members will record decisions and changes that alter or add complexity to the original plan. The work plan is a living document for the duration of the project and is not considered complete until the project is finished. [The work plan template is found in Sharepoint](https://emory.sharepoint.com/:w:/r/sites/EUVRoseLibrary/Shared%20Documents/Cataloging%20and%20Collection%20Processing/Collection%20Processing/Collection%20Processing%20Templates/Processing%20Flags,%20Forms,%20and%20Templates/New%20Workplan%20Template.docx?d=w9de3bcf567954df39b638cf9abbe1b8f&csf=1&web=1&e=ab6K3h).

Much of the content of the work plan will come from the collection analysis. When the plan is complete, the Archivist will share the document with the Head of Processing and the curator responsible for acquiring the collection. Each party may make suggestions or ask questions about elements of the plan. Once the Archivist has reviewed the collection and completed the preliminary workplan, they should set up a meeting with the relevant Curator and the Assistant Director of Public Services to discuss strategy or gather contextual information. Curators and Public Services Unit members often have important information about collection creators or identified research topics that can influence archival processing decisions. Any updates from this meeting should be added to the work plan and shared with the processing students.

When the processing project is complete and all updates have been made to the work plan, file it in the relevant permanent collection file (CL-2).
...
#### 14.2.1.1 Students
[Handbook for hiring Student Library Workers](https://hr.emory.edu/eu/_includes/documents/sections/hr-rep-resources/student-new-hire-training-manual.pdf)

Create an orientation packet for a new student's first day. Include:

* Rose Library orientation materials include:
	* Rose Library promotional material
	* [Rose Library welcome and rules](https://emory.sharepoint.com/:w:/r/sites/EUVRoseLibrary/Shared%20Documents/Student%20Employees/Collection%20Services%20Student%20Employees/CS%20Student%20Orientation%20Files/Student%20welcome%20and%20rules.docx?d=w51e94aca14914c2e91d71771e6376b13&csf=1&web=1&e=iFQfBG)
	* [Emory University Libraries' Student Employee Handbook]([https://hr.emory.edu/eu/_includes/documents/sections/hr-rep-resources/student-new-hire-training-manual.pdf)
	* [Emergency procedures](https://emory.sharepoint.com/:w:/r/sites/EUVRoseLibrary/Shared%20Documents/Student%20Employees/Collection%20Services%20Student%20Employees/CS%20Student%20Orientation%20Files/Emergency%20Procedures%20for%20Students.doc?d=w084f098c41b64decbd6f3a721267dd06&csf=1&web=1&e=LAmtzh](https://emory.sharepoint.com/:w:/r/sites/EUVRoseLibrary/_layouts/15/Doc.aspx?sourcedoc=%7BA83BC881-2BEA-4590-811D-EF6AB6114E2C%7D&file=STUDENT%20EMPLOYEE%20HANDBOOK%2020-21-1.doc&action=default&mobileredirect=true))
...
#### 14.2.1.2 New Staff
In advance of a new staff person starting work, review the Rose Library on-boarding checklist, the [Emory University Libraries checklist]([https://emory-my.sharepoint.com/:w:/g/personal/lstarra_emory_edu/IQBXBSXwkT33QoRV4wNSYmegAcvxvYKn7oaO1teqOB2zw6U?e=GihYDZ](https://emory.sharepoint.com/:w:/r/sites/EmoryUniversityLibraries/EUL_HR/_layouts/15/Doc.aspx?sourcedoc=%7BA78DE1A7-29D6-4A73-A1B2-238543008781%7D&file=EUL%20New%20Hire%20Employee%20Checklist.docx&action=default&mobileredirect=true)), [Handbook Governing The Librarian Series for Faculty-Equivalent Librarians within Emory Libraries](https://emory.sharepoint.com/:b:/s/EmoryUniversityLibraries/IQDkxnr6_DsZRo6Q_1SKTy9tAZYw3_qKYmqaz6XBjxO2LHs?e=HKfFJ4), and the [Rose Library Staff Handbook](https://emory.sharepoint.com/:w:/r/sites/EUVRoseLibrary/Shared%20Documents/RL%20Staff%20Handbook.docx?d=w304e80a217a245bb8444a8dfbc304917&csf=1&web=1&e=dHt6iv).

Setting up the IT on-boarding system through [Service Now](https://emory.service-now.com/sp?id=sc_cat_item&sys_id=0174f11f93199a10076cfb4e1dba1053)
...
* Create a training schedule for, at least, the first two weeks including:
	* Meetings with people that the new staff member will interact with regularly
	* Meetings with Rose Library Leadership  
...
* Have new staff person shadow other staff when learning new tasks;
	* Especially Reading Room training and shadowing
