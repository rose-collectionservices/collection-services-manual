...
* [3.2 Accessioning workflow](#32-accessioning-workflow)
	* [3.2.1 Airtable Acquisitions and Accessioning base](#321-airtable-acquisitions-and-accessioning-base)
 		* [3.2.1.1 Using "Views" in Airtable](3211-using-"views"-in-airtable)
   		* [3.2.1.1 Create Airtable checklist](#3211-create-airtable-checklist)
  		* [3.2.1.3 Finalize and update Airtable record](#3213-finalize-and-update-airtable-record)
	* [3.2.2 Accessioning Workflow for Collections Archivists](#322-accessioning-workflow-for-collections-archivists)
...
- [ ] Update [processing statistics spreadsheet](<https://emory.sharepoint.com/:x:/r/sites/EUVRoseLibrary/_layouts/15/Doc.aspx?sourcedoc=%7BE8382D29-2826-46D8-A17B-240C1A701E96%7D&file=Annual%20Processing%20Reports.xlsx&action=default&mobileredirect=true>)
